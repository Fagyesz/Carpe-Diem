...
<div class="flex items-center">
    <div class="w-full max-w-md">
        <form class="bg-orange-100 shadow-lg rounded px-8 pt-6 pb-8 mb-4 text-center" method="POST" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                <input class="mr-2 leading-tight" type="checkbox" id="remember_me" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
            ...
            <div class="w-full flex justify-center mx-2">
                <button type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2" onclick="window.location.href='<?php echo e(url('auth/google')); ?>'">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampplatest\htdocs\Carpe-Diem\Carpe-Diem\resources\views/auth/login.blade.php ENDPATH**/ ?>