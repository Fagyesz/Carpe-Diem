                ...
                <form method="POST" action="/profile/edit" enctype="multipart/form-data">
                    ...
                    <div class="py-4 pl-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="female" class="ml-2 text-sm font-medium  " @checked($user->gender ==
                                "Female")>Female</label>
                        </div>
                    </div>
                    <div class="mb-6 pl-4">
                        <label for="bio" class="inline-block text-lg mb-2">Bio:</label>
                        <textarea type="text" class="border border-gray-200 rounded p-2 w-full resize-none" name="bio"
                    ...
                    <div class="mb-6 pl-4">
                        ...
                        <img class="hidden w-80 mr-6 md:block"
                            src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('/images/no_avatar.jpg') }}"
                            alt="" />
                    ...
                    <div class="grid justify-items-stretch">
                        <div class="flex flex-row mt-8">
                            ...
                            <div class="justify-self-stretch ml-16">
